...
/**
 * 给Button显示倒计时 CountTimeViewUtil
 * Created by oranges on 2016/9/26.
 */
public class CountTimeViewUtil extends CountDownTimer {
     ...
     */
    public CountTimeViewUtil(long millisInFuture, long countDownInterval, TextView btn, int endStrRid) {
     ...
     * 参数上面有注释
     */
    public CountTimeViewUtil(TextView btn, int endStrRid) {
        super(TIME_COUNT, 1000);
        this.btn = btn;
        this.endStrRid = endStrRid;
    }

    public CountTimeViewUtil(TextView btn) {
        super(TIME_COUNT, 1000);
        this.btn = btn;
